...
public abstract class VideoAnalyzer {
   ...
   public static String getID(String filename) {
      ...
      // Format YYYY-MM-DD-ID-Q-Hormone-Concentration-numVideo-Medium (with
      // hormone)
    ...
    * @return
    */
   public static Map<String, Trial> simulateTrials(String analysis, double beta, double responsiveCells,
         int MAXSIMULATIONS) {
